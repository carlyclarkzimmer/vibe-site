...
| Existing app campaign root | `/beyond-the-bottleneck-2026` | Landing | Route moved; legacy path redirects; inline form removed | Set a working signup destination for campaign CTAs, test it end to end, and update campaign email, social, and ad links |
...
requirements in the final column are confirmed.
