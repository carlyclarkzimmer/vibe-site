...
export default function Page() {
  return <div className={`${styles.page} ${styles.deliveryPage} laserCoachDeliveryPage`}>
    <section className={styles.hero}><div className={styles.inner}><p className={styles.eyebrow}>Install⚡️5-Minute Laser Coach</p><h1>Video Walkthrough</h1><div className={styles.video}><iframe src="https://player.vimeo.com/video/1059763588?h=d4fb2fa0a4&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" title="5-Minute Laser Coach video walkthrough" allow="autoplay; fullscreen; picture-in-picture" allowFullScreen /></div><a className={styles.cta} href={install} target="_blank" rel="noopener noreferrer">→ Click here to install 5-Minute Laser Coach ←</a><p className={styles.heroSupport}>If you need help at any time, please reach out to carly@carlyclarkzimmer.com</p><p className={styles.heroSupport}>I&apos;d also love to know how the GPT works for you so let&apos;s connect on Instagram! <a className={styles.instagramLink} href="https://www.instagram.com/carlyclarkzimmer/" target="_blank" rel="noopener noreferrer">📸 @carlyclarkzimmer</a></p></div></section>
    ...
    <section className={styles.patternInterrupt}><div className={styles.patternInterruptInner}>
      ...
      <p>For 21 days, we’ll focus on <strong>one recurring behavior</strong> together.</p>
      ...
      <p>It’s 21 days of unlimited asynchronous Voxer coaching with me.</p>
